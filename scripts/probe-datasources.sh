...
for pair in "sh600519 A-share" "hk00700 HK" "usAAPL US" "jp7203 JP"; do
  set -- $pair
...
hdr 'Sina hq.sinajs.cn — backup source for A-share / US (needs Referer)'
for pair in "sh600519 A-share" "gb_aapl US"; do
  set -- $pair
